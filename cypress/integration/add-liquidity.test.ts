describe('Add Liquidity', () => {
  it('loads the two correct tokens', () => {
    ...
    cy.get('#add-liquidity-input-tokenb .token-symbol-container').should('contain.text', 'BYC')
  })
  ...
  it('does not crash if BYC is duplicated', () => {
    ...
    cy.get('#add-liquidity-input-tokena .token-symbol-container').should('contain.text', 'BYC')
    cy.get('#add-liquidity-input-tokenb .token-symbol-container').should('not.contain.text', 'BYC')
  })
